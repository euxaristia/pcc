...
const Lexer_1 = require("./dist/lexer/Lexer");
const Parser_1 = require("./dist/parser/Parser");
const SemanticAnalyzer_1 = require("./dist/semantic/SemanticAnalyzer");
const IRGenerator_1 = require("./dist/codegen/IRGenerator");
const AssemblyGenerator_1 = require("./dist/codegen/AssemblyGenerator");
const ELFGenerator_1 = require("./dist/codegen/ELFGenerator");
async function main() {
    const code = `
int main() {
    return 42;
